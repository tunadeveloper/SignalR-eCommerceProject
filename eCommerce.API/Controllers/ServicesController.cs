...
namespace eCommerce.API.Controllers
{
    ...
    public class ServicesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetList()
        {
            ...
            var mapping = _mapper.Map<List<ResultServiceDTO>>(values);
            return Ok(mapping);
        }
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            var mapping = _mapper.Map<ResultServiceDTO>(value);
            return Ok(mapping);
        }
        ...
        {
            var values = await _service.GetListByFilterAsyncBL(x => x.ServiceTitle.Contains(name));
            var mapping = _mapper.Map<List<ResultServiceDTO>>(values);
            return Ok(mapping);
        }

        [HttpPost]
        public async Task<IActionResult> Insert(CreateServiceDTO dto)
        {
            var mapping = _mapper.Map<Service>(dto);
