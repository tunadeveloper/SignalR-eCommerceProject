...
namespace eCommerce.API.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetList()
        {
            ...
            var mapping = _mapper.Map<List<ResultMessageDTO>>(values);
            return Ok(mapping);
        }
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            var mapping = _mapper.Map<ResultMessageDTO>(value);
            return Ok(mapping);
        }
        ...
        {
            var values = await _service.GetListByFilterAsyncBL(x => x.MessageSubject.Contains(name));
            var mapping = _mapper.Map<List<ResultMessageDTO>>(values);
            return Ok(mapping);
        }

        [HttpPost]
        public async Task<IActionResult> Insert(CreateMessageDTO dto)
        {
            var mapping = _mapper.Map<Message>(dto);
